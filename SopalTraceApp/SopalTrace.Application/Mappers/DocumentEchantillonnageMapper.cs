...
public static class DocumentEchantillonnageMapper
{
    public static DocumentEchantillonnageResponseDto? ToResponseDto(this DocumentEchantillonnageEntete? entity)
    {
        if (entity == null) return null;

        return new DocumentEchantillonnageResponseDto
        {
            Id = entity.Id,
    ...
    public static DocumentEchantillonnageEntete? ToEntity(this CreateDocumentEchantillonnageRequestDto? dto)
    {
    ...
    public static void UpdateEntity(this DocumentEchantillonnageEntete entity, UpdateDocumentEchantillonnageRequestDto dto)
    {
