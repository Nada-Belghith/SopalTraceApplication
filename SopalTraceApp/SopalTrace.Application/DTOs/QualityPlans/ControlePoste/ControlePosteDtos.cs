...
namespace SopalTrace.Application.DTOs.QualityPlans.ControlePoste;

// --- REQUÊTES ---
public record CreateControlePosteRequestDto
{
...
public record SaveControlePosteDto
{
    public string PosteCode { get; init; }
    public string Nom { get; init; }
    public string Remarques { get; init; }
...
// --- RÉPONSES ---
public record ControlePosteResponseDto
{
    public Guid Id { get; init; }
    public string PosteCode { get; init; }
    public string Nom { get; init; }
